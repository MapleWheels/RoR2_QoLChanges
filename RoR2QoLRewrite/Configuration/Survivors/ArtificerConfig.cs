...
namespace RoR2QoLRewrite.Configuration.Survivors
{
    public class ArtificerConfig : ConfigDataModel
    {
        ...
        public static ConfigData<int> M1Fire_LevelsPerCharge { get; set; } = new ConfigData<int>()
        {
            DescriptionString = "The amount of levels for each extra charge in M1 Fire Bolt",
            DefaultValue = 10
        };
        public static ConfigData<int> M1Fire_MaxLevelCharges { get; set; } = new ConfigData<int>()
        {
            DescriptionString = "The max amount of charges gained by level by M1 Fire Bolt",
            DefaultValue = 99
        };
        public static ConfigData<int> M1Fire_BackupMagsPerCharge { get; set; } = new ConfigData<int>()
        {
            DescriptionString = "The amount of back magazines for each extra charge in M1 Fire Bolt",
            DefaultValue = 3
        };
        public static ConfigData<int> M1Fire_MaxBackupMagCharges { get; set; } = new ConfigData<int>()
        {
            DescriptionString = "The max amount of charges gained by backup magazines by M1 Fire Bolt",
            DefaultValue = 99
        };
        public static ConfigData<float> M1Fire_CooldownPerAttackSpeedRatio { get; set; } = new ConfigData<float>()
        {
            DescriptionString = "The % cooldown reduction gained per 1% bonus attack speed.",
            DefaultValue = 0.1f
        };
        public static ConfigData<float> M1Fire_MaxCooldownFromAttackSpeed { get; set; } = new ConfigData<float>()
        {
